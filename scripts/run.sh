# gowalla
python train.py --trans_loc_file KGE/POI_graph/gowalla_scheme2_transe_loc_temporal_100.pkl --trans_interact_file KGE/POI_graph/gowalla_scheme2_transe_user-loc_100.pkl --log_file result/log_gowalla --gpu 0
# foursquare
